...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args0) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("01/01/2024"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", zenitsu);
        Post post2 = new Post(null, sdf.parse("05/01/2024"), "Bom dia", "Acordei feliz hoje!", zenitsu);
